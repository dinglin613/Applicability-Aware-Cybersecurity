...
| Paper notation | [`notation.md`](notation.md) |
...
| Physical-impact settings and additional sensitivity checks | [`ablation_sensitivity.md`](ablation_sensitivity.md) |

## Materials

- Representative deterministic inputs used to generate constraints C1--C7.
- Notation used in the topology, applicability, risk, scheduling, and
